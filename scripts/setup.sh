...
echo ""
echo "  5. REQUIRED for the claude provider — install the Claude GitHub App:"
echo "     https://github.com/apps/claude  →  Configure  →  select this repository"
echo ""
echo "     The secret is not enough on its own. Without the app installed, every"
echo "     agent run fails in seconds with a 401 on the app token exchange, even"
echo "     though labels sync and the workflow fires. Repository admin required."
echo "     With Claude Code in a terminal, /install-github-app does both at once."
echo ""
